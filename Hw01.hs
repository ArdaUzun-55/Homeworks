...
--------------------------------------------------------------------------------
-- DESCRIPTION
-- TODO <- what string does foo contain?
-- "!dlroW ,olleH" (reversed Hello World)
foo = map chr [33, 100, 108, 114, 111, 87, 32, 44, 111, 108, 108, 101, 72]

--------------------------------------------------------------------------------
-- DESCRIPTION
-- TODO <- what string does bar contain?
-- "Haskell is fun"
bar = map chr [72, 97, 115, 107, 101, 108, 108, 32, 105, 115, 32, 102, 117, 110, 33]

--------------------------------------------------------------------------------
-- DESCRIPTION
-- TODO <- what string does baz contain?
-- "Bubblegum"	
baz = map chr [66, 117, 98, 98, 108, 101, 103, 117, 109]

--------------------------------------------------------------------------------
-- DEFINITION
question1 foo bar baz = takeCharacters 7 bar
